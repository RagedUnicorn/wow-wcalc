...
/**
 * TooltipSpecificTest class tests for a response where a specific tooltip is returned
 */
@RunWith(Parameterized.class)
public class TooltipSpecificTest extends  BaseTest {
  private static final Logger logger = LoggerFactory.getLogger(TooltipSpecificTest.class);

  private String version;
  private String apiPath = "/tooltip";

  public TooltipSpecificTest(String version) {
  ...
  public void SchemaValidationTest() {
    ...
    given()
      ...
      .get(this.version + this.apiPath + id)
      .then()
      .assertThat().body(matchesJsonSchemaInClasspath("schemas/tooltip_schema.json"));
  }
}
